...
const char descriptor_table_protodef_register_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "teRequest\032\032.register_service.Response\"\000\022"
  "L\n\tReadValue\022!.register_service.ReadItem"
  "Request\032\032.register_service.Response\"\000\022N\n"
  "\nWriteValue\022\".register_service.WriteItem"
  "Request\032\032.register_service.Response\"\000b\006p"
  "roto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_register_2eproto = {
  false, false, 1045, descriptor_table_protodef_register_2eproto, "register.proto", 
